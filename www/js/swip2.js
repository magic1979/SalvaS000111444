...
function listaStory() {
	...
	$.ajax({
		   ...
		   $("span").on("swiperight",function(){
			...
			$(document).on("touchmove", "#delete", function(e){
				e.preventDefault();
				var numlist = this.id
				numlist = numlist.substring(6)
